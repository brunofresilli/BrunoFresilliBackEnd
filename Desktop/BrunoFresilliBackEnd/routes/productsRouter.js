...
router.get('/', async (req, res) => {
    try {
        ...
        if (req.session.user) {
            // Si hay un usuario en la sesión, obtenemos su nombre
            const userName = req.session.user.first_name;
            // Agregamos el mensaje de bienvenida al objeto de respuesta
            products.welcomeMessage = `¡Bienvenido, ${userName}!`;
        }
        ...
        const response = {
            ...
            // Incluimos el mensaje de bienvenida en la respuesta
            welcomeMessage: products.welcomeMessage
        };
